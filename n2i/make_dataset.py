...
for text in text_list:
    ...
    if ave_senti >= 0:
        ...
        s = 0
    text_sentiment_dict = {'text':text, 'sentiment':s}
    text_sentiment_list.append(text_sentiment_dict)

result_df = pd.DataFrame(text_sentiment_list)
result_df.to_csv('./data/app_review_sentiment.csv')
